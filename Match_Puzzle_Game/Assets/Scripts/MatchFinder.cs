...
public void CheckForBombs()
   {
        for(int i=0; i<currentMatches.Count; i++)
        {
            ...
            if(gem.posIndex.y>0)      // ____________________________________________________________________
            {
    ...
    public void MarkBombArea(Vector2Int bombPos , Gem theBomb)
    {
        ...
        currentMatches=currentMatches.Distinct().ToList();   //Prevent to duplicate
    }
